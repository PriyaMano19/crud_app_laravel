...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css"
        integrity="sha384-dT7Kyj5tt9CjP9ngmx3rV21EqV4Xu1muPFjzuL2JAeFwzEx5if45FgG76I5T0cFv" crossorigin="anonymous">
    ...
    <div class="container register-form">
        ...
        <form method="POST" action="/addregister" enctype="multipart/form-data">
            ...
            <div class="form-group mb-2">
                ...
                <input type="file" class="form-control" name="profile_image[]" placeholder="Upload Your Images"
                    multiple>
            </div>
