...
<head>
    ...
    <style>
        body {
            background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ4k68fU0EI9hirtrJwaCGhcfBc5cBIUVhe9g&s'); 
...
<body>
    <div class="container register-form">
        ...
        @endif
        <form method="POST" action="/addregister" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group mb-2">
                <label for="contact_num" class="label-style">Contact Number</label>
            ...
            <div class="form-group mb-2">
                <label for="profile_image" class="label-style">Profile Pictures</label>
                <input type="file" class="form-control" name="profile_image[]"  placeholder="Upload Your Images" multiple>
            </div>            
